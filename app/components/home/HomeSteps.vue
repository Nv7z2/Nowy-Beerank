        ...
        <div class="home-steps__steps-wrapper">
            <ul class="home-steps__steps-ul">
                <li
                    ...
                    :class="{
                        'home-steps__step--active': currentHash == '#analiza' || !currentHash,
                    }"
                >
                    <a href="#analiza">
                        Wstępna analiza potrzeb to proces identyfikacji i oceny wymagań oraz
                        oczekiwań, niezbędnych do skutecznego zrealizowania projektu lub zadania.
                    </a>
                </li>
                <li
                    id="oferta"
                ...
                >
                    <a href="#oferta">
                        Stworzenie propozycji oferty odpowiadającej zidentyfikowanym potrzebom i
                        oczekiwaniom klienta, aby zwiększyć szanse na jej akceptację.
                    </a>
                </li>
                <li
                    id="umowa"
                ...
                >
                    <a href="#umowa">
                        Opracowanie szczegółowych warunków umowy, które będą regulować współpracę
                        między stronami, w tym zakres prac, terminy, wynagrodzenie i inne istotne
                        kwestie.
                    </a>
                </li>
            </ul>
